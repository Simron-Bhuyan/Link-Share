                        ...
                        <div className="flex justify-between items-center gap-2 w-full">
                            ...
                            {postedBy?._id === user?.googleId && (
                                <button
                                    ...
                                    className="bg-white p-2 opacity-70 hover:opacity-100 text-white font-bold text-dark text-base rounded-3xl hover:shadow-md outlined-none"
                                >
                                    <AiTwotoneDelete style={{ color: '#ff0000' }} />
                                </button>
                            )}
                        </div> 
                    </div>
